...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values='class count', names='class', title=f"Launch Success at site {entered_site}")
        return fig
...
def get_scatter(value1, value2):
    ...
    if value1 == 'ALL':
        ...
        fig = px.scatter(filtered_df3, x="Payload Mass (kg)", y="class", color="Booster Version Category", title=f"Payload and Success for site {value1}")
        return fig
